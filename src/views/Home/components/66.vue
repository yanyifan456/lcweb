<template>
    <div class="common-layout">
        <el-container>
            <el-header
                style="height: 110px;width: 100%;background-color: #089BAB;  margin: 0;  padding: 0;display: flex;">
                ...
                <el-aside width="200px">
                    <el-menu style="overflow: hidden;" class="el-menu-vertical" router unique-opened>
                        ...
                        <template v-for="menu in filteredMenus">
                            <!-- 有子菜单的渲染为 submenu -->
                            <el-submenu v-if="menu.children && menu.children.length > 0" :index="menu.index"
                                :key="menu.index">
                                <template #title>
                                    <i :class="menu.icon"></i>
