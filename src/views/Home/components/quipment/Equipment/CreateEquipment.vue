        ...
        <el-row :gutter="40">
          ...
          <el-col :span="8">
            <el-form-item label="设备类型：" prop="deviceType" required style="margin-bottom: 0">
              <el-select v-model="deviceForm.deviceType" placeholder="请选择">
          ...
          <el-col :span="8">
            <el-form-item label="设备品牌：" prop="deviceBrand" required style="margin-bottom: 0">
              <el-select v-model="deviceForm.deviceBrand" placeholder="请选择">
                <el-option v-for="item in deviceBrandList" :label="item.deviceBrand" :value="item.deviceBrand">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
    ...
    <div class="section-container">
      ...
      <div class="table-container">
        <el-table :data="deviceProperties" style="width: 100%" border :header-cell-style="{
          ...
          <el-table-column prop="serialNumber" label="序号" width="100" type="index" align="center"></el-table-column>
          <el-table-column label="项目名称" prop="itemName" align="center">
          </el-table-column>
          <el-table-column label="项目检测编号" prop="itemNo" align="center">
          </el-table-column>
          <!-- <el-table-column label="备注" prop="itemRemark" align="center">
          </el-table-column> -->
        </el-table>
      </div>
    </div>
...
<script>
// import { getLinkage, addgetlist } from "../../../../api/Equipmentstorage.js";
import { getList, getDeviceProject } from "@/api/deviceType.js";
import { createDeviceManage, getDeviceManage } from "@/api/deviceManage.js";
